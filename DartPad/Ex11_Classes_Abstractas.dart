// 1. Definición de la interfaz <Informacion>.
abstract class Informacion {
  void mostrarInformacion(); // Método que deben implementar las clases.
}

// 2. Definición de la clase abstracta <Persona> que implementa la interfaz.
abstract class Persona implements Informacion {
  ...
  // 3. Constructor que inicializa los atributos de la clase abstracta Persona.
  Persona({
    ...
    required this.fechaRegistroPersona,
    required this.estatus,
  });
}

// 4. Declaración de la clase <Paciente> que extiende de Persona e implementa la interfaz.
class Paciente extends Persona {
  ...
  String estatusMedico;  // Estado médico del paciente (DEFAULT 'Control').
  ...
  Paciente({
    ...
    this.estatusMedico = 'Control',  // Valor por defecto: 'Control'.
  ...
  // 6. Sobrescribir el método mostrarInformacion() de Informacion para mostrar detalles adicionales.
  @override
  ...
  // 7. Sobrescritura de la función registrarDefuncion().
  ...
  void leerPaciente() {
    mostrarInformacion(); // Llama al método mostrarInformacion().
  }
  ...
  void eliminarPaciente() {
    estatus = false; // Cambia el estatus a inactivo.
...
void main() {
  ...
  pacienteExistente.leerPaciente(); // Muestra la información actualizada del paciente.
  ...
  print(' \n ------------------------ Caso 4: Eliminar paciente -----------------');
  pacienteExistente.eliminarPaciente(); // Cambia el estatus a inactivo.
